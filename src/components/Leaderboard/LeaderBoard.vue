<template lang="">
    <div class="leaderboard__container-inner">
        <ul>
            ...
            <transition-group name="leaderboard-slide" class='transition-group-li' tag="li"  v-else>
                <li v-for="(player, index) in sortedPlayers" :key="index">
                    <span class="image__position">
                        <span class="image" :style="{ 'background-image': 'url(' + player.avatar + ')' }"></span>
                        <span class="position">
                            <span>{{ index + 1 }}</span>
                        </span>
                    </span>
...
console.log(players.value, gameCode)
// watchEffect(() => {
...
<style lang="scss" scoped>
    .leaderboard-slide-enter-active, .leaderboard-slide-leave-active {
    ...
    .leaderboard-slide-enter, .leaderboard-slide-leave-to {
